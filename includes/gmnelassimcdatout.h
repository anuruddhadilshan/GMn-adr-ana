...
#ifndef GMNELASSIMCDATOUT_H
#define GMNELASSIMCDATOUT_H
...
public:
	...
	OutputSIMC(ElasticEventG4SBS& event, TString path_outputdir, const char* outputfilename, const bool is_simc = false)
	: m_event{event}, m_outputdirpath{path_outputdir}, m_outputfilename{outputfilename}, m_is_simc{is_simc},
