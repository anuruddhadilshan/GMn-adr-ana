#include "eventclass.h" // Class of the HCal-NDE analysis.

#ifndef BESTHCALCLUSNDE_H
#define BESTHCALCLUSNDE_H
...
private:
	...
	Event& m_hcalNDEana_event; // Class for HCal NDE End-Point-Method event selection.
	...
	{
		m_shadctime = m_hcalNDEana_event.return_SHADCTime();
	}

public:

	BestHCalClus( Event& event, const double coincut_mean, const double coincut_sigma, const double coincut_sigmafactor ) : m_hcalNDEana_event{event}, m_sbshcal_heclus_e{m_hcalNDEana_event.return_HCalHEClusEArryPtr()}, m_sbshcal_heclus_atime{m_hcalNDEana_event.return_HCalHEClusAtimeArryPtr()}, m_sbshcal_heclus_x{m_hcalNDEana_event.return_HCalHEClusXArryPtr()}, m_sbshcal_heclus_y{m_hcalNDEana_event.return_HCalHEClusYArryPtr()},
