...
public:
	...
	ElasticEvent(TChain* const C, const int num_SBSKine, const TString target, const double num_SBSFieldScale,const double cut_MinPreShE, const double cut_MinGEMHitsOnTrack, const double cut_MinBBTrP, const double cut_MaxTrackChi2divNdof, const double cut_VzCutUpStream, double cut_VzCutDwnStream) 
	: m_C{C}, m_SBSKineNum{num_SBSKine}, m_target{target}, m_SBSFieldScale{num_SBSFieldScale}, m_cut_MinPreShE{cut_MinPreShE}, m_cut_MinGEMHitsOnTrack{cut_MinGEMHitsOnTrack}, m_cut_MinBBTrP{cut_MinBBTrP}, m_cut_MaxTrackChi2divNdof{cut_MaxTrackChi2divNdof}, m_cut_VzCutUpStream{cut_VzCutUpStream}, m_cut_VzCutDwnStream{cut_VzCutDwnStream},
