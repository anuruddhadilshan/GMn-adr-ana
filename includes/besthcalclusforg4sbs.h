...
#ifndef BESTHCALCLUSFORG4SBS_H
#define BESTHCALCLUSFORG4SBS_H


class BestHCalClusForG4SBS
{
private:

	ElasticEventG4SBS& m_event; // Class for elastic event selection.
