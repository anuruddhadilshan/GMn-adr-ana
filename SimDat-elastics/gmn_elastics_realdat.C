...
#include "../includes/gmnelasrealdatout.h"


void print_analysis_percentage(double cuurentevent_ana_percentage, int& previousevent_ana_percentage_int);


void gmn_elastics_realdat( const char* configfilename, const char* outputfilename = "gmn_elastics_realdat" )
{
	...
	Output output{ event, bestHCalClus, path_OutputDir, outputfilename };
